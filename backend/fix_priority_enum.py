#!/usr/bin/env python3
"""
Script to check and fix the priority enum in the database.
...
from app.models.issue import Priority
...
def check_and_fix_priority_enum():
    ...
    with engine.connect() as conn:
        ...
        expected_values = [p.value for p in Priority]
        print(f"Expected priority enum values from model: {expected_values}")
